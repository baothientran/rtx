...
impl Disk {
    ...
    pub fn uniform_sample_surface(&self, sample: &vec2::Vec2) -> Option<vec3::Vec3> {
    ...
    pub fn concentric_sample_surface(&self, sample: &vec2::Vec2) -> Option<vec3::Vec3> {
        let offset = sample * 2.0 - vec2::Vec2::from(1.0);
