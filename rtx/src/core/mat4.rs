...
impl ops::Mul<Mat4> for Mat4 {
    ...
    fn mul(self, rhs: Mat4) -> Mat4 { 
        let c0 = self.cols[0] * rhs.cols[0].x + self.cols[1] * rhs.cols[0].y + self.cols[2] * rhs.cols[0].z + self.cols[3] * rhs.cols[0].w;
        let c1 = self.cols[0] * rhs.cols[1].x + self.cols[1] * rhs.cols[1].y + self.cols[2] * rhs.cols[1].z + self.cols[3] * rhs.cols[1].w;
        let c2 = self.cols[0] * rhs.cols[2].x + self.cols[1] * rhs.cols[2].y + self.cols[2] * rhs.cols[2].z + self.cols[3] * rhs.cols[2].w;
        let c3 = self.cols[0] * rhs.cols[3].x + self.cols[1] * rhs.cols[3].y + self.cols[2] * rhs.cols[3].z + self.cols[3] * rhs.cols[3].w;
        return Mat4 {
            cols: [c0, c1, c2, c3]
        };
    }
...
mod test {
    ...
    fn test_mul_vec4_mat4() {
        ...
        assert!(vec4::Vec4::equal_epsilon(&result, &expected, math::EPSILON_F32_5));
    }
